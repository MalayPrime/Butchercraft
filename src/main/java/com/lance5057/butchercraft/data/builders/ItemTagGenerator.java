...
public class ItemTagGenerator extends ItemTagsProvider {
	...
	protected void addTags() {
		tag(ButchercraftItemTags.MEAT_RAW).add(ButchercraftItems.BEEF_RIB.get(), ButchercraftItems.BEEF_RIBS.get(),
		...
		tag(ButchercraftItemTags.MEAT_COOKED).add(ButchercraftItems.COOKED_BEEF_RIB.get(),
		...
		tag(ButchercraftItemTags.BEEF_RAW).add(ButchercraftItems.BEEF_RIB.get(), ButchercraftItems.BEEF_RIBS.get(),
				ButchercraftItems.BEEF_ROAST.get(), ButchercraftItems.BEEF_SCRAPS.get(),
				ButchercraftItems.BEEF_STEW_MEAT.get(), ButchercraftItems.CUBED_BEEF.get(),
				ButchercraftItems.GROUND_BEEF.get());

		tag(ButchercraftItemTags.PORK_RAW).add(ButchercraftItems.PORK_RIB.get(), ButchercraftItems.PORK_RIBS.get(),
		...
		tag(ButchercraftItemTags.MUTTON_RAW).add(ButchercraftItems.LAMB_RIB.get(), ButchercraftItems.LAMB_RIBS.get(),
		...
		tag(ButchercraftItemTags.BEEF_COOKED).add(ButchercraftItems.COOKED_BEEF_RIB.get(),
				ButchercraftItems.COOKED_BEEF_RIBS.get(), ButchercraftItems.COOKED_BEEF_ROAST.get(),
				ButchercraftItems.COOKED_BEEF_SCRAPS.get(), ButchercraftItems.COOKED_BEEF_STEW_MEAT.get(),
				ButchercraftItems.COOKED_CUBED_BEEF.get(), ButchercraftItems.COOKED_GROUND_BEEF.get());
		...
		tag(ButchercraftItemTags.GELATIN_PROVIDER).add(ButchercraftItems.COW_HIDE.get(), ButchercraftItems.PIG_HIDE.get(),
